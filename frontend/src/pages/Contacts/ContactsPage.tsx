...
export function ContactsPage() {
  ...
  return <>
    ...
    {create && <CreateDialog title="Add contact" path={organizationPath(org.id) + 'contacts/'} invalidate={contactKeys.byOrganization(org.id)} onClose={() => setCreate(false)} fields={[
