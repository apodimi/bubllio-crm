...
export function CompaniesPage() {
  ...
  return <>
    ...
    {create && <CreateDialog title="Add company" path={organizationPath(org.id) + 'companies/'} invalidate={companyKeys.byOrganization(org.id)} onClose={() => setCreate(false)} fields={[
