...
class InstallationAdminInvitationTests(APITestCase):
    ...
    def invite(self, email="it-two@example.com"):
        ...
        with patch("organizations.installation_admin_views.send_installation_admin_invitation_email") as send:
    ...
    def test_expired_and_failed_delivery_do_not_grant_admin(self):
        ...
        self.client.force_authenticate(self.administrator)
        with patch("organizations.installation_admin_views.send_installation_admin_invitation_email", side_effect=RuntimeError("SMTP down")):
